...
import {
  register, login, logout, getProfile, getProfileById, assignManager,
} from '../controllers/userController.js';
import { authMiddleware, authorizeRoles } from '../middleware/authMiddleware.js';
import {
  createTask, getAllTasks, getTaskById, updateTask, deleteTask, assignTask, unassignTask, getTaskAnalytics,
 ...
 *       - name: hasManager
 *         in: query
 *         description: Filter profiles to include only users who do not have a manager assigned. Set to 'true' to get users with a manager.
 *         required: false
 *         schema:
 *           type: string
 *       - name: sort
 ...
 *         description: Internal server error
 */
router.delete('/tasks/:id', authMiddleware, authorizeRoles('admin', 'manager'), deleteTask);
 ...
 *         description: Internal server error
 */
router.patch('/tasks/unassign/:id', authMiddleware, authorizeRoles('admin', 'manager'), unassignTask);
 ...
 *         description: Internal server error
 */
router.get('/analytics', authMiddleware, authorizeRoles('admin', 'manager', 'user'), getTaskAnalytics);
